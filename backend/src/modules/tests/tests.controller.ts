...
export class TestController {
  ...
  @Post()
  async createTest(@Body() dto: CreateTestDto, @Req() req: any) {
  ...
  @Get(':id/builder')
  async getBuilder(@Param('id') testId: string, @Req() req: any) {
  ...
  async removeQuestion(
    ...
    return this.testService.removeQuestion(testId, testQuestionId, req.user);
  }
  ...
  async togglePublish(
    ...
    return this.testService.togglePublish(testId, body.isPublished, req.user);
  }
  ...
  async toggleActive(
    ...
    return this.testService.toggleActive(testId, body.isActive, req.user);
  }

  @Get(':id/preview')
  async previewTest(@Param('id') testId: string, @Req() req: any) {
    return this.testService.previewTest(testId, req.user);
  }
}
